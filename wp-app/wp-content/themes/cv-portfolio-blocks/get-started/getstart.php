...
define('CV_PORTFOLIO_BLOCKS_BUY_NOW',__('https://www.wpradiant.net/blocks/cv-wordpress-theme/','cv-portfolio-blocks'));
define('CV_PORTFOLIO_BLOCKS_LIVE_DEMO',__('https://www.wpradiant.net/pattern/cv-portfolio-blocks/','cv-portfolio-blocks'));
define('CV_PORTFOLIO_BLOCKS_PRO_DOC',__('https://www.wpradiant.net/tutorial/cv-portfolio-blocks-pro/','cv-portfolio-blocks'));
	...
	<div class="cv-portfolio-blocks-appearence wrap about-wrap">
		...
		<div class="four-col">
			...
			<div class="col">
				...
				<h3><i class="dashicons dashicons-cart"></i><?php esc_html_e( 'Upgrade to Pro', 'cv-portfolio-blocks' ); ?></h3>

				<p>
					<?php esc_html_e( 'To gain access to extra theme options and more interesting features, upgrade to pro version.', 'cv-portfolio-blocks' ); ?>
				</p>

				<p>
					<a class="button green button-primary" href="<?php echo esc_url( CV_PORTFOLIO_BLOCKS_BUY_NOW ); ?>" target="_blank"><?php esc_html_e( 'Upgrade to Pro', 'cv-portfolio-blocks' ); ?></a>
				</p>
